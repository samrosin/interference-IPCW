...
# Date: May 7, 2020
#
# This file contains one function, sim_dataset(), which simulates a single dataset.
# It takes two arguments: n_i, the group/cluster size which is assumed fixed for all groups,
# and m, the number of clusters
##########
...
sim_dataset <- function(n_i = n_i,
  ...
  #####         Each individual in a group has the same random effect
  
  b_is <- rnorm(n=n/n_i, mean=0, sd=sqrt(1.0859)) 
