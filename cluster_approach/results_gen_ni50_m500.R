...
libs <- paste(user_home_directory,"RLibs",sep="")
...
output_filename <- paste("results_ni",n_i,"_m",m,"_",arg,".csv",sep="")
results_wd <- paste(user_home_directory,"results_datasets/results_ni",
                    n_i,"_m",m,sep="")
