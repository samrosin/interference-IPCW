...
N_I=10
N_SIMS=1000
SUBDIR_NAME=ranef_exp

srun --output=/dev/null --error=/dev/null R CMD BATCH --no-save --no-restore "--args $RAN_SEED $M $N_I $N_SIMS $SUBDIR_NAME" dataset_gen_ranef_exp.R dataset_gen_$SUBDIR_NAME.Rout
