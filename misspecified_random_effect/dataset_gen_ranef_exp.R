...
sim_dataset <- function(n_i = n_i,
  ...
  #####         same random effect.
  #### Here they are generated from the distribution 
  #### X-E[X] where X is Exponential with mean 1.0421,
  #### giving a non-symmetric distribution (skewness 2)
  #### with mean 0 and variance approximately 1.08
  ####
  b_is <- rexp(n/n_i, rate = 1/1.0421) - 1.0421
