...
# are generated from a logistic distribution in this file
#
...
sim_dataset <- function(n_i = n_i,
  ...
  #####         same random effect.
  #### Here they are generated from a mean-zero logistic 
  #### with variance 1.0859. 
  #### this corresponds to a location parameter of mu=0 
  #### and a scale parameter of s = .574521
  b_is <- rlogis(n=n/n_i, location = 0, scale = .574521)
