...
# are generated from a t-distribution with 10 degrees of freedom
#
...
sim_dataset <- function(n_i = n_i,
  ...
  #####         same random effect.
  #### Here they are generated from a mean-zero central t distribution 
  #### with variance 1.25=10/8
  #### corresponding to 10 degrees of freedom
  b_is <- rt(n=n/n_i, df = 10)
