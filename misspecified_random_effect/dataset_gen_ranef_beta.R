...
sim_dataset <- function(n_i = n_i,
  ...
  #####         same random effect.
  #### Here b_i = X - EX where X=2.8B and 
  #### B has a beta distribution with shape parameters .2 and .4 and thus mean 1/3, 
  #### such that the mean of b_i is 0, variance is approximately 1.09,
  #### and skewness is approximately 0.69
  ####
  b_is <- 2.8*rbeta(n = n/n_i, 2, 4) - (2.8*.2/.6)
